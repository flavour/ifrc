...
S3.timeline.onResize=function(){if(null==S3.timeline.resizeTimerID)S3.timeline.resizeTimerID=window.setTimeout(function(){S3.timeline.resizeTimerID=null;S3.timeline.tl.layout()},500)};$(document).ready(function(){$(window).load(function(){if(S3.timeline.calendar)SimileAjax.History.enabled=!1,S3.timeline.onLoadCalendar();else if(S3.timeline.tl_start)SimileAjax.History.enabled=!1,S3.timeline.onLoad()});$(window).resize(function(){if(S3.timeline.tl)S3.timeline.onResize()})});
