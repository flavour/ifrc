...
'Add New Layer Configuration': 'Add New Layer Configuration',
...
'Add all organisations which are involved in different roles in this project': 'Add all organisations which are involved in different roles in this project',
...
'An Assessment Template can be selected to create a Disaster Assessment. Within a Disaster Assessment, responses can be collected and results can analyzed as tables, charts and maps': 'An Assessment Template can be selected to create a Disaster Assessment. Within a Disaster Assessment, responses can be collected and results can analysed as tables, charts and maps',
...
'Edit OpenStreetMap Layer': 'Edit OpenStreetMap Layer',
...
'Enter a valid future date %(min)s!': 'Enter a valid future date %(min)s!',
...
'Est. Value per Pack': 'Est. Value per Pack',
...
'List Jobs': 'List Jobs',
'List Kits': 'List Kits',
'List Layer Configurations in Profile': 'List Layer Configurations in Profile',
...
'Remove Layer Configuration from Profile': 'Remove Layer Configuration from Profile',
...
'Search for a Project by description.': 'Search for a Project by description.',
