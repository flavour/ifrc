...
"""
    ...
    Note for Developers:
    /models/000_config.py is NOT in the Git repository, to avoid leaking of sensitive
    or irrelevant information into the repository.
    For changes to be committed, please also edit:
    private/templates/default/000_config.py
"""
...
# Base settings
deployment_settings.base.system_name = T("Relief Goods Inventory & Monitoring System")
...
#deployment_settings.security.self_registration = False
...
deployment_settings.fin.currency_default = "PHP"
...
# Currently unused
#deployment_settings.gis.display_L1 = False
